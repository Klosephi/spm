 ...
 * </p>
 * <ul>
 *   <li>{@link org.pklose.simplespec.simplespec.impl.EnumDeclarationImpl#getValues <em>Values</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnumDeclarationImpl extends ElementImpl implements EnumDeclaration
{
  ...
  {
    return SimplespecPackage.Literals.ENUM_DECLARATION;
  }
  ...
  public EList<String> getValues()
  {
    if (values == null)
    {
      values = new EDataTypeEList<String>(String.class, this, SimplespecPackage.ENUM_DECLARATION__VALUES);
    }
    return values;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SimplespecPackage.ENUM_DECLARATION__VALUES:
        return getValues();
    }
