 ...
 * </p>
 * <ul>
 *   <li>{@link org.pklose.simplespec.simplespec.impl.EnumImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnumImpl extends LiteralImpl implements org.pklose.simplespec.simplespec.Enum
{
  /**
  ...
  {
    return SimplespecPackage.Literals.ENUM;
  }
    ...
    if (type != null && type.eIsProxy())
    {
      ...
      if (type != oldType)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SimplespecPackage.ENUM__TYPE, oldType, type));
      }
    }
    return type;
  }
  ...
  public void setType(EnumDeclaration newType)
  {
    ...
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SimplespecPackage.ENUM__TYPE, oldType, type));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SimplespecPackage.ENUM__TYPE:
