 ...
 * generated by Xtext
 */
package org.pklose.simplespec.ui.contentassist.antlr;
...
public class SimplespecParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.pklose.simplespec.ui.contentassist.antlr.internal.InternalSimplespecParser createParser() {
		org.pklose.simplespec.ui.contentassist.antlr.internal.InternalSimplespecParser result = new org.pklose.simplespec.ui.contentassist.antlr.internal.InternalSimplespecParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getAssociationAccess().getMultiplicityAssignment_1(), "rule__Association__MultiplicityAssignment_1");
					put(grammarAccess.getAssociationAccess().getNameAssignment_2(), "rule__Association__NameAssignment_2");
					put(grammarAccess.getAssociationAccess().getTypeAssignment_4(), "rule__Association__TypeAssignment_4");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.pklose.simplespec.ui.contentassist.antlr.internal.InternalSimplespecParser typedParser = (org.pklose.simplespec.ui.contentassist.antlr.internal.InternalSimplespecParser) parser;
